...
<script>
import SpotifyTextIcon from '~/components/icons/social/SpotifyTextIcon.vue'
import YoutubeTextIcon from '~/components/icons/social/YoutubeTextIcon.vue'

export default {
  name: 'DecarbonomicsPodcastPage',
